...
final class AddStockAlertViewController: ViewSetup, UITextFieldDelegate, UNUserNotificationCenterDelegate, MessagingDelegate, UIApplicationDelegate {
    ...
    @objc private func add(_ button: UIButton) {
        ...
        if !newAlertBoolTuple.1 && !newAlertBoolTuple.0 && !newAlertBoolTuple.2 && !newAlertBoolTuple.3 && !newAlertBoolTuple.4 && !newAlertBoolTuple.5 {
            ...
            FiretailDatabase.shared.saveAlertToFirebase(ticker: newAlertTicker, price: finalAlertPrice, isGreaterThan: alertTriggerWhenGreaterThan, deleted: false, email: newAlertBoolTuple.0, sms: newAlertBoolTuple.1, flash: newAlertBoolTuple.3, urgent: newAlertBoolTuple.4, triggered: "false", push: newAlertBoolTuple.2, intelligent: newAlertBoolTuple.intelligent, alertLongName: newAlertLongID, priceString: priceString, data2: UserInfo.phone)
        } else {
            FiretailDatabase.shared.saveAlertToFirebase(ticker: newAlertTicker, price: finalAlertPrice, isGreaterThan: alertTriggerWhenGreaterThan, deleted: false, email: newAlertBoolTuple.0, sms: newAlertBoolTuple.1, flash: newAlertBoolTuple.3, urgent: newAlertBoolTuple.4, triggered: "false", push: newAlertBoolTuple.2, intelligent: newAlertBoolTuple.intelligent, alertLongName: newAlertLongID, priceString: priceString)
        }
